...
docker run --rm -it --gpus all -p 8501:8501 --user $(id -u):$(id -g) \
  -v ${PWD}/tfx/pipeline/examples/forest_fires_pipeline/Pusher/pushed_model:/models/forest_fires_model \
  -e MODEL_NAME=forest_fires_model -t tensorflow/serving:2.4.1-gpu
#else
